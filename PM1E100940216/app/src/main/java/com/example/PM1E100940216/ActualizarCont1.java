...
public class ActualizarCont1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ActualizarCont2);
    ...
    private void EditarContacto() {
        ...
        try {
            ...
            db.close();
            Toast.makeText(getApplicationContext(),"actualización correctamente", Toast.LENGTH_SHORT).show();
